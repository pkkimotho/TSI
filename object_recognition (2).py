...
def speech(text):
    ...
    output.save("C:/Users/USER/PycharmProjects/firstPythonProject/sounds/output.mp3")
    playsound("C:/Users/USER/PycharmProjects/firstPythonProject/sounds/output.mp3")
